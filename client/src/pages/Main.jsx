...
const DroppableList = ({ list, index, onCardDrop }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      className="mr-3 w-60 h-fit rounded-md p-2 bg-amber-400 flex-shrink-0"
    >
...
const Main = () => {
  ...
  return (
    ...
    >
      <div className="p-3 bg-amber-400 flex justify-between w-full bg-opacity-50">
